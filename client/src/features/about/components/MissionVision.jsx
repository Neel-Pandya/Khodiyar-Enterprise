    ...
    <section className="section bg-bg-light">
      <div className="container">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          {/* Mission Card */}
          <div
            className="bg-white p-10 md:p-12 rounded-[2.5rem] shadow-xl shadow-primary/5 border border-primary/5 flex flex-col items-start hover:shadow-2xl transition-shadow duration-300"
          >
